...
from data.dataset import CBCTDataset, setup_datasets
from metrics import mean_corr_coef as mcc
from utils import Logger, checkpoint
from .nets import iVAE, DiscreteIVAE, VAE, DiscreteVAE, iVAEforCBCT


def IVAE_wrapper(batch_size=256, max_iter=7e4, seed=None, lr=1e-2, cuda=True, inference_dim=None,
    ...
    dset, _, _ = setup_datasets("/home/portafaixa/PycharmProjects/CausalVAE/data/HNC_Survival/")
    S = None
    ...
    model = iVAEforCBCT(latent_dim=512)
    # if not discrete:
